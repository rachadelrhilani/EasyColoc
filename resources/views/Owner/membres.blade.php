...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        ...
        <form action="{{ route('owner.membres') }}" method="GET" class="relative mb-6">
            ...
            <svg class="w-5 h-5 text-slate-400 absolute left-4 top-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        </form>
                ...
                @forelse($utilisateursDisponibles as $userDispo)
                    <div class="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-100">
                        ...
                        <form action="#" method="POST">
                            ...
                            <button class="px-4 py-2 bg-indigo-600 text-white text-sm font-bold rounded-lg hover:bg-indigo-700 transition">
                                Envoyer Invitation
                            </button>
                        </form>
                    </div>
                ...
                <div class="p-4 flex items-center justify-between hover:bg-slate-50 transition">
                    ...
                    <div class="flex items-center space-x-6 text-right">
                        ...
                        @if(auth()->user()->role === 'owner' && $m->id !== auth()->id())
                            <button class="p-2 text-slate-300 hover:text-red-500 transition" title="Retirer de la coloc">
